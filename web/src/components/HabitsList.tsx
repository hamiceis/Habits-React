    ...
    <div className="mt-6 flex flex-col gap-3">
      {habitsInfo?.possibleHabits.map((habit) => {
        return (
          ...
          >
            <div className="h-8 w-8 flex justify-center items-center bg-zinc-900 rounded-lg border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 
